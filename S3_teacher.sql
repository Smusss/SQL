...
LIMIT 5; -- Исходное значение сортироровки - по воз-ю; DESC - по убыванию

-- Сортировку можно делать и по 2, и даже по 3 столбцам 
SELECT 
	id,
    salary,
    first_name, 
...
UPDATE media
SET created_at = "2023-06-11 21:21:25"
WHERE id = 1;

UPDATE media
SET created_at = "2023-05-11 21:21:25"
WHERE id = 2;
UPDATE media
SET created_at = "2023-05-11 21:21:25"
WHERE id = 6;
...
WHERE id = 7;
UPDATE media
SET created_at = "2023-04-11 21:21:25"
WHERE id = 3;
UPDATE media
SET created_at = "2023-04-11 21:21:25"
WHERE id = 4;
-- Создадим архив документов (сколько доков было создано в каждом месяце)
SELECT
